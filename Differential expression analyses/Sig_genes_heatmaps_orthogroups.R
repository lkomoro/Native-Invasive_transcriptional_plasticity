...
library(ggplot2)
library(tidyr)
setwd("~/Box/Github_repositories/Native-Invasive_transcriptional_plasticity/DDIG_data&analyses/Transdecoder&Orthofinderwork/Orthofinder_dists_and_heatmaps")
getwd()

#data readin & setup:####
voomresults<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/Orthogroup_annot_compiled_contrastslimma_rm2rds.txt")
...
infiles <- list.files(pattern = "../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results", full.names = T)#fix later, relative path issue?
#Ds:
CTMax2.0.HC.Ds<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax2.0.HC.Ds.txt")
CTMax2.0.HC.Ds<-CTMax2.0.HC.Ds[,1:2]
CTMax2.0.HC.Ds<-rename(CTMax2.0.HC.Ds, c("X"="Orthogroup", "logFC"="CTMax2.0.HC.DslogFC"))

CTMax4.0.HC.Ds<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax4.0.HC.Ds.txt")
CTMax4.0.HC.Ds<-CTMax4.0.HC.Ds[,1:2]
CTMax4.0.HC.Ds<-rename(CTMax4.0.HC.Ds, c("X"="Orthogroup", "logFC"="CTMax4.0.HC.DslogFC"))

CTMax6.0.HC.Ds<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax6.0.HC.Ds.txt")
CTMax6.0.HC.Ds<-CTMax6.0.HC.Ds[,1:2]
CTMax6.0.HC.Ds<-rename(CTMax6.0.HC.Ds, c("X"="Orthogroup", "logFC"="CTMax6.0.HC.DslogFC"))

CTMax2.60.HC.Ds<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax2.60.HC.Ds.txt")
CTMax2.60.HC.Ds<-CTMax2.60.HC.Ds[,1:2]
CTMax2.60.HC.Ds<-rename(CTMax2.60.HC.Ds, c("X"="Orthogroup", "logFC"="CTMax2.60.HC.DslogFC"))

CTMax4.60.HC.Ds<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax4.60.HC.Ds.txt")
CTMax4.60.HC.Ds<-CTMax4.60.HC.Ds[,1:2]
CTMax4.60.HC.Ds<-rename(CTMax4.60.HC.Ds, c("X"="Orthogroup", "logFC"="CTMax4.60.HC.DslogFC"))

CTMax6.60.HC.Ds<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax6.60.HC.Ds.txt")
...
#Mb:
CTMax2.0.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax2.0.HC.Mb.txt")
CTMax2.0.HC.Mb<-CTMax2.0.HC.Mb[,1:2]
CTMax2.0.HC.Mb<-rename(CTMax2.0.HC.Mb, c("X"="Orthogroup", "logFC"="CTMax2.0.HC.MblogFC"))

CTMax4.0.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax4.0.HC.Mb.txt")
CTMax4.0.HC.Mb<-CTMax4.0.HC.Mb[,1:2]
CTMax4.0.HC.Mb<-rename(CTMax4.0.HC.Mb, c("X"="Orthogroup", "logFC"="CTMax4.0.HC.MblogFC"))

CTMax8.0.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax8.0.HC.Mb.txt")
CTMax8.0.HC.Mb<-CTMax8.0.HC.Mb[,1:2]
CTMax8.0.HC.Mb<-rename(CTMax8.0.HC.Mb, c("X"="Orthogroup", "logFC"="CTMax8.0.HC.MblogFC"))

CTMax12.0.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax12.0.HC.Mb.txt")
CTMax12.0.HC.Mb<-CTMax12.0.HC.Mb[,1:2]
CTMax12.0.HC.Mb<-rename(CTMax12.0.HC.Mb, c("X"="Orthogroup", "logFC"="CTMax12.0.HC.MblogFC"))

CTMax2.60.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax2.60.HC.Mb.txt")
CTMax2.60.HC.Mb<-CTMax2.60.HC.Mb[,1:2]
CTMax2.60.HC.Mb<-rename(CTMax2.60.HC.Mb, c("X"="Orthogroup", "logFC"="CTMax2.60.HC.MblogFC"))

CTMax4.60.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax4.60.HC.Mb.txt")
CTMax4.60.HC.Mb<-CTMax4.60.HC.Mb[,1:2]
CTMax4.60.HC.Mb<-rename(CTMax4.60.HC.Mb, c("X"="Orthogroup", "logFC"="CTMax4.60.HC.MblogFC"))

CTMax8.60.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax8.60.HC.Mb.txt")
CTMax8.60.HC.Mb<-CTMax8.60.HC.Mb[,1:2]
CTMax8.60.HC.Mb<-rename(CTMax8.60.HC.Mb, c("X"="Orthogroup", "logFC"="CTMax8.60.HC.MblogFC"))

CTMax12.60.HC.Mb<-read.delim("../Orthogroup_DE_analyses/Temptime_splitanalysis/voom_results_CTMax12.60.HC.Mb.txt")
...
c<-merge(c,CTMax2.0.HC.Mb)
c<-merge(c,CTMax4.0.HC.Mb)
c<-merge(c,CTMax8.0.HC.Mb)
c<-merge(c,CTMax12.0.HC.Mb)
c<-merge(c,CTMax2.60.HC.Mb)
c<-merge(c,CTMax4.60.HC.Mb)
c<-merge(c,CTMax8.60.HC.Mb)
c<-merge(c,CTMax12.60.HC.Mb)
#can reorder if prefer different order of groups for visualizing (if not using group clustering similarity)
siggeneFC<-merge(siggeneskey,c)
#write.csv(siggeneskey,"orthogroup.adjp0.05.sig.genes.key.csv",row.names = F)
#################################################################
#figure out appropriate cutoffs:
quartz(10,10)
ggplot(siggeneFC, aes(x=(siggeneFC[,3]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,4]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,5]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,6]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,7]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,8]))) +geom_density()

ggplot(siggeneFC, aes(x=(siggeneFC[,9]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,10]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,11]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,12]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,13]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,14]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,15]))) +geom_density()
ggplot(siggeneFC, aes(x=(siggeneFC[,16]))) +geom_density()
summary(siggeneFC[,3:16])#if want to adjust scales, add breaks for outliers etc
#################################################################
#Distributions:####
#actually the distributions are interesting, may want to show
#1. both species together####
str(siggeneFC)
siggeneFC.L<-gather(siggeneFC, key = "Treatment", value = "logFC", CTMax6.0.HC.DslogFC,CTMax4.0.HC.DslogFC,CTMax2.0.HC.DslogFC,CTMax6.60.HC.DslogFC,CTMax4.60.HC.DslogFC,CTMax2.60.HC.DslogFC,CTMax2.0.HC.MblogFC,CTMax4.0.HC.MblogFC,CTMax8.0.HC.MblogFC,CTMax12.0.HC.MblogFC,CTMax2.60.HC.MblogFC,CTMax4.60.HC.MblogFC,CTMax8.60.HC.MblogFC,CTMax12.60.HC.MblogFC)

siggeneFC.L$Treatment<-factor(siggeneFC.L$Treatment)
levels(siggeneFC.L$Treatment)
siggeneFC.L$Treatment<-ordered(siggeneFC.L$Treatment,c("CTMax6.0.HC.DslogFC"  , "CTMax6.60.HC.DslogFC",  "CTMax4.0.HC.DslogFC",  "CTMax4.60.HC.DslogFC","CTMax2.0.HC.DslogFC" ,"CTMax2.60.HC.DslogFC" ,"CTMax12.0.HC.MblogFC" , "CTMax12.60.HC.MblogFC" ,  "CTMax8.0.HC.MblogFC"  , "CTMax8.60.HC.MblogFC" ,"CTMax4.0.HC.MblogFC","CTMax4.60.HC.MblogFC" ,  "CTMax2.0.HC.MblogFC" , "CTMax2.60.HC.MblogFC"))

pdf("orthogroup.dist.logFC0.05.pdf", width=6, height=12) 
ggplot(siggeneFC.L, aes(x=logFC)) +geom_density()+
    theme_bw()+
  facet_grid(Treatment~.)
dev.off()  
#using the significant genes across both species is not representative of the fold changes that occur in DS in the ones that respond?
#remake these seperate for each species, including sig genes for each and compare, think about which is better depiction of what is going on...
#################################################################
#2. Each species seperate####
...
#alternately can manipulate further to shift, etc if you have skewed (and/vs. outlier) issues
...
#################################################################
#Explore 0.01 sig####
siggenes1<-voomresults.adjp[apply(voomresults.adjp[, -1], MARGIN = 1, function(x) any(x <= 0.01)), ]#keep only genes where at least one treatment has FDR<=0.01
siggeneskey1<-merge(voomresults.key,siggenes1)
siggeneskey1<-siggeneskey1[,1:2]
siggeneFC1<-merge(siggeneskey1,c)
write.csv(siggeneskey1,"orthogroup.adjp0.01.sig.genes.key.csv",row.names = F)

siggeneFC.L1<-gather(siggeneFC1, key = "Treatment", value = "logFC", CTMax6.0.HC.DslogFC,CTMax4.0.HC.DslogFC,CTMax2.0.HC.DslogFC,CTMax6.60.HC.DslogFC,CTMax4.60.HC.DslogFC,CTMax2.60.HC.DslogFC,CTMax2.0.HC.MblogFC,CTMax4.0.HC.MblogFC,CTMax8.0.HC.MblogFC,CTMax12.0.HC.MblogFC,CTMax2.60.HC.MblogFC,CTMax4.60.HC.MblogFC,CTMax8.60.HC.MblogFC,CTMax12.60.HC.MblogFC)

siggeneFC.L1$Treatment<-factor(siggeneFC.L1$Treatment)
levels(siggeneFC.L1$Treatment)
siggeneFC.L1$Treatment<-ordered(siggeneFC.L1$Treatment,c("CTMax6.0.HC.DslogFC"  , "CTMax6.60.HC.DslogFC",  "CTMax4.0.HC.DslogFC",  "CTMax4.60.HC.DslogFC","CTMax2.0.HC.DslogFC" ,"CTMax2.60.HC.DslogFC" ,"CTMax12.0.HC.MblogFC" , "CTMax12.60.HC.MblogFC" ,  "CTMax8.0.HC.MblogFC"  , "CTMax8.60.HC.MblogFC" ,"CTMax4.0.HC.MblogFC","CTMax4.60.HC.MblogFC" ,  "CTMax2.0.HC.MblogFC" , "CTMax2.60.HC.MblogFC"))
...
rownames(mat_real.data2) <- rnames
#to determine range and breaks, look over the distributions:
summary(siggeneFC1[,3:16])
ggplot(siggeneFC.L1, aes(x=Treatment, y=logFC)) + 
  geom_boxplot() + theme(axis.text.x=element_text(angle = -45, hjust = 0))
#Looks like most within -4 to 4, some outliers especially  for Mb, unsuprisingly; note that several of the most negative outliers for Mb above are now removed oddly, must have a lot of variation
...
#add in for the outliers:
breaks=append(breaks,7.6)
breaks=append(breaks, -5,0) # the zero just puts this on the negative end where it is supposed to be
breaks #check
my_palette <- colorRampPalette(c("blue", "gray90", "red"))(n=length(breaks)-1)

#create 0.01 heatmap:####
pdf("orthogroups.logFC.heatmap.padj0.01.pdf", width=6, height=8)
heatmap.2(mat_real.data2, 
          main = "Temp 0.01 Sig logFC",
          notecol="black",
          ...
          Colv="NA")
dev.off()
#Not that much different, and removes data unneccessarily so stick with adjp 0.05 for now
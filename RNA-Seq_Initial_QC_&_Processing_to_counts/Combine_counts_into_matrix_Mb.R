...
write.table(base1,file="menidia_combined_rawcounts.txt",sep="\t",quote=FALSE)#hacky way to just get a table summarizing all the coverage of PE and S across samples
